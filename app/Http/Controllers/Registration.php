    ...
    public function Registrations(Request $request)
    {
        try {
            ...
            if ($user_type == 'Client') {
                ...
                return response()->json(["msg" => "Client Account Created Successfully"], 200);
                ...
                Log::info('Loan Officer Account Created Successfully');
                return response()->json(["msg" => "Loan Officer Account Created Successfully"], 200);
            } else {
